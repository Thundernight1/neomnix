...
const neonButtonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 relative overflow-hidden group",
  {
    variants: {
      variant: {
        default:
          "bg-cyber-cyan text-cyber-navy shadow-none hover:bg-cyber-cyan/90 neon-glow-cyan",
        outline:
          "border border-cyber-cyan/50 bg-transparent text-cyber-cyan hover:bg-cyber-cyan/10 neon-glow-cyan",
        purple:
          "bg-cyber-purple text-white shadow-none hover:bg-cyber-purple/90 neon-glow-purple",
